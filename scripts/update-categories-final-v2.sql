-- First, add sort_order column if missing
ALTER TABLE categories ADD COLUMN IF NOT EXISTS sort_order INTEGER DEFAULT 0;

-- Update Home Services to Home Repair Services (if Home Services still exists)
UPDATE categories 
SET 
...
-- Add the new categories (skip if they already exist)
