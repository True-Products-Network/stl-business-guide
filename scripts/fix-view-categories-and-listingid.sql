-- Fix public_approved_listings view - restore categories AND add listing_id
-- Run this in Supabase SQL Editor

DROP VIEW IF EXISTS public_approved_listings;

-- Create view with proper category joins AND listing_id for analytics
...
SELECT 
    ...
    b.created_at,
    b.updated_at,
    -- ADD listing_id for analytics tracking
    l.id as listing_id,
    -- Location data
    bl.city,
    bl.state,
...
SELECT business_name, category, plan_status, plan_key, city, listing_id
