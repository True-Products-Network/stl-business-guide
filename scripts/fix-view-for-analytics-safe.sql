-- First check what columns actually exist in businesses table
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'businesses'
ORDER BY ordinal_position;

-- Then update public_approved_listings view to include listing_id
...
-- Verify the view
SELECT id, business_name, listing_id FROM public_approved_listings LIMIT 3;
